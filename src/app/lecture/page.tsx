...
const lectureFeatures = [
  ...
  },
  {
    title: "幅広い対象に対応",
    description:
      "小・中・高の児童・生徒向け、保護者向け、職員研修、人権学習など、対象者と主旨に合わせた内容でプログラムいたします。但し専門的な学術講演会ではありません。あくまでも１個人の思いと体験を基にした内容になります。",
  },
];
  ...
  return (
    <div className="pt-24 pb-20">
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn>
            <h3 className="font-serif text-[15px] md:text-2xl font-bold mb-6 text-center">
      ...
      <section className="py-16 px-4 bg-section-alt">
        <div className="max-w-3xl mx-auto">
          <FadeIn>
            ...
            <div className="space-y-4 text-foreground/70 leading-relaxed">
              <p>
                人数が２０〜５０人程度の小さな会も行っています。ちょっとしたサークルの集会、学習会、あるいは会社、喫茶店やお寺さんなど・・・。このような会はなるべく費用がかからないように、小西が簡単な音響機材を車に積み込んで、自ら運転して一人で現地に伺っています。そのために荷物の積み降ろしなど、主催者の方にお手伝いして頂かなければならないこともありますけど・・・。そんな感じでよければ、いつでも呼んで下さい。
              </p>
            </div>
          </FadeIn>
        </div>
              ...
              {[
                {
                  step: "1",
                  title: "お問い合わせ",
                  text: "お電話、FAX、メール、またはお問い合わせフォームよりご連絡ください。主催、日時、会場、対象者、テーマ（主旨）、予算などをお知らせください。",
                },
                {
                  step: "2",
                  title: "打ち合わせ",
                  text: "なるべくご要望に合わせた講演内容を検討いたします。テーマや時間、演奏曲目なども柔軟に対応したいと考えております。また、トイレや階段の状態、セッティング、リハーサルの時間帯なども打ち合わせいたします。",
                },
                {
                  step: "3",
                  title: "講演当日",
                  text: "開始約２時間前に到着。セッティングとリハーサルを行います。ハイエースクラスの車１台、若しくは２台、小西とスタッフ１〜２名で伺います。ステージへの上り下りの際、車椅子の介助をお願いすることがあります。よろしくお願いします。",
                },
              ].map((item, i) => (
                <div
                  key={i}
