            ...
            <div className="flex flex-col md:flex-row gap-10 items-start">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-4 text-foreground/70 leading-relaxed">
                  <p>
                    1962年6月27日、兵庫県豊岡市生まれ。先天性骨形成不全症により、幼少期から車椅子で生活。
                  </p>
                  <p>
                    小・中学校時代は親元を離れ、神戸市の療育センターで治療を受けながら養護学校で義務教育を受ける。12歳の頃、フォークソングに魅了されギターの練習を始める。
                  </p>
                  <p>
                    高等部時代よりシンガーソングライターとしての活動を開始し、オリジナル曲の創作とコンサート活動をスタート。佛教大学社会学部社会福祉学科に進学し、4年間京都で下宿生活を送る。
                  </p>
                  <p>
                    卒業後、姫路市のコンピュータ会社に営業マンとして2年間勤務。1990年、長男の誕生を機に独立。以来、全国各地でコンサート・講演活動を展開している。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-16">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { year: "1974", text: "12歳でフォークソングに出会い、ギターを始める" },
                  { year: "1978", text: "高等部時代、シンガーソングライターとして活動開始" },
                  { year: "1982", text: "佛教大学社会学部社会福祉学科に進学（京都）" },
                  { year: "1986", text: "大学卒業後、姫路市のコンピュータ会社に営業マンとして就職" },
                  { year: "1990", text: "長男の誕生を機に独立。全国でのコンサート・講演活動を本格始動" },
                  { year: "現在", text: "コンサート・講演の実績は2,500本以上。全国各地で活動を続ける" },
                ].map((item, i) => (
                  <div
                    key={i}
